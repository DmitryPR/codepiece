...
<div align="center">
  ...
  [![Contributions Welcome][welcome]](https://github.com/TheAlgorithms/TypeScript/blob/master/CONTRIBUTING.md)
...
Before contributing upstream, read the [Contribution Guidelines](https://github.com/TheAlgorithms/TypeScript/blob/master/CONTRIBUTING.md). You can look
at other [TheAlgorithms Repositories][repositories] or the [issues with a "help wanted" label][help-wanted] for
inspiration. Maintainer list: [CODEOWNERS](https://github.com/TheAlgorithms/TypeScript/blob/master/.github/CODEOWNERS) on GitHub.
